            ...
            <form action="{{ route('usersManagement.update', $users->id) }}" method="post">
                ...
                <div class="space-y-2 font-sans">
                    <div class="">
                        ...
                        <input type="text" name="name" class="w-full rounded-lg border-2 border-purple-600 text-purple-900 focus:outline-none focus:border-purple-900 hover:border-blue-600 @error('name') is-invalid @enderror"  placeholder="Input name" value="{{ $users->name }}" required autofocus>
                        @error('name')
                    ...
                    <div class="">
                        ...
                        <input type="email" name="email" class="w-full rounded-lg border-2 border-purple-600 text-purple-900 focus:outline-none focus:border-purple-900 hover:border-blue-600 @error('email') is-invalid @enderror"  placeholder="Input email" value="{{ $users->email }}" required>
                        @error('email')
                            <p class="text-red-600 font-bold text-[12px]">{{ $message }}</p>
                        @enderror
                    </div>
                    <div class="">
                        ...
                        <input type="password" name="password" class="w-full rounded-lg border-2 border-purple-600 text-purple-900 focus:outline-none focus:border-purple-900 hover:border-blue-600 @error('password') is-invalid @enderror"  placeholder="Input password">
                        @error('password')
                            <p class="text-red-600 font-bold text-[12px]">{{ $message }}</p>
                        @enderror
                    </div>
