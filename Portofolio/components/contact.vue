        ...
        <div id="project" class="text-center">
            ...
            <div class="flex flex-wrap justify-evenly">
                <div class="h-[200px] w-[200px] space-y-4 rounded-3xl my-2 bg-slate-700 hover:border-2 hover:border-purple-400 text-white text-center p-5">
                    <div class="h-[50px] w-[50px] mx-auto">
                        <svg xmlns="http://www.w3.org/2000/svg" width="46" height="46" fill="currentColor" class="bi bi-signpost-2 text-purple-400" viewBox="0 0 16 16">
                    ...
                    <h1 class=" uppercase text-lg text-white ">Addres</h1>
                    <h1 class="  text-sm text-gray-400 ">Adipasir 07/02, Warudoyong street, Rakit, Banjarnegara</h1>
                </div>
                <div class="h-[200px] w-[200px] space-y-4 rounded-3xl my-2 bg-slate-700 hover:border-2 hover:border-purple-400 text-white text-center p-5">
                    <div class="h-[50px] w-[50px] mx-auto">
                        <svg xmlns="http://www.w3.org/2000/svg" width="46" height="46" fill="currentColor" class="bi bi-phone text-purple-400" viewBox="0 0 16 16">
                            <path d="M11 1a1 1 0 0 1 1 1v12a1 1 0 0 1-1 1H5a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1zM5 0a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h6a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2z"/>
                            <path d="M8 14a1 1 0 1 0 0-2 1 1 0 0 0 0 2"/>
                        </svg>
                    </div>
                    <h1 class=" uppercase text-lg text-white ">Contact number</h1>
                    <h1 class="  text-sm text-gray-400 ">085870603466</h1>
                </div>
                <div class="h-[200px] w-[200px] space-y-4 rounded-3xl my-2 bg-slate-700 hover:border-2 hover:border-purple-400 text-white text-center p-5">
                    <div class="h-[50px] w-[50px] mx-auto">
                        <svg xmlns="http://www.w3.org/2000/svg" width="46" height="46" fill="currentColor" class="bi bi-send text-purple-400" viewBox="0 0 16 16">
                            <path d="M15.854.146a.5.5 0 0 1 .11.54l-5.819 14.547a.75.75 0 0 1-1.329.124l-3.178-4.995L.643 7.184a.75.75 0 0 1 .124-1.33L15.314.037a.5.5 0 0 1 .54.11ZM6.636 10.07l2.761 4.338L14.13 2.576zm6.787-8.201L1.591 6.602l4.339 2.76z"/>
                        </svg>
                    </div>
                    <h1 class=" uppercase text-lg text-white ">Email</h1>
                    <h1 class="  text-sm text-gray-400 ">antihack696@gmail.com</h1>
                </div>
                <div class="h-[200px] w-[200px] space-y-4 rounded-3xl my-2 bg-slate-700 hover:border-2 hover:border-purple-400 text-white text-center p-5">
                    <div class="h-[50px] w-[50px] mx-auto">
                        <svg xmlns="http://www.w3.org/2000/svg" width="46" height="46" fill="currentColor" class="bi bi-globe-asia-australia text-purple-400" viewBox="0 0 16 16">
                    ...
                    <h1 class=" uppercase text-lg text-white ">Website</h1>
                    <h1 class="  text-sm text-gray-400 ">rendi.tiket</h1>
                </div>
           </div>
           ...
           <div class="flex flex-wrap justify-center  mt-10 sm:p-20 px-8 sm:px-0 sm:space-x-4 pb-16 text-start">
                <div class="space-y-7 sm:w-[250px] my-2">
                    ...
                    <div class="flex justify-start space-x-4">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" fill="currentColor" class="bi bi-instagram text-white" viewBox="0 0 16 16">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" fill="currentColor" class="bi bi-youtube text-white" viewBox="0 0 16 16">
